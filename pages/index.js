      ...
      <div className="relative max-w-3xl mx-auto rounded-3xl overflow-hidden bg-white shadow-lg mt-4">
        ...
        <div className="bg-white p-6 -mt-12 relative z-10">
          ...
          <div className="mt-3">
            ...
            <button onClick={() => handlePayment(25.00, 'Plano Mensal – R$ 25,00')} className="w-full subscription-gradient text-black py-4 px-6 rounded-2xl font-medium transition-all mb-2 flex justify-between items-center shadow-sm">
          ...
          <div className="mt-3">
            ...
            <button onClick={() => handlePayment(37.90, 'Plano 3 Meses – R$ 37,90')} className="w-full subscription-gradient text-black py-4 px-6 rounded-2xl font-medium transition-all mb-2 flex justify-between items-center shadow-sm">
              <span>Plano 3 Meses</span>
              <span>R$ 37,90</span>
            </button>
            
            <button onClick={() => handlePayment(55.00, 'Plano 6 Meses – R$ 55,00')} className="w-full subscription-gradient text-black py-4 px-6 rounded-2xl font-medium transition-all mb-2 flex justify-between items-center shadow-sm">
              <span>Plano 6 Meses</span>
              <span>R$ 55,00</span>
            </button>
            
            <button onClick={() => handlePayment(120.00, 'Plano Anual – R$ 120,00')} className="w-full subscription-gradient text-black py-4 px-6 rounded-2xl font-medium transition-all flex justify-between items-center shadow-sm">
        ...
        {activeTab === 'medias' && (
          <div className="content-transition">
            ...
            <div className="text-center">
              <button onClick={() => handlePayment(25.00, 'Plano Mensal – R$ 25,00')} className="w-full bg-gradient-to-r from-orange-500 to-pink-500 text-white py-3 px-6 rounded-lg font-semibold hover:from-orange-600 hover:to-pink-600 transition-all">
